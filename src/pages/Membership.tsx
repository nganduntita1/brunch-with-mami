    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-12">
        <div className="container mx-auto px-4">
          <h1 className="font-playfair text-3xl md:text-4xl italic text-center mb-8">Join Our Sisterhood</h1>
          
          <div className="max-w-4xl mx-auto mb-16">
            <div className="bg-white rounded-xl overflow-hidden shadow-lg">
              {/* Membership Header */}
              <div className="bg-gradient-to-r from-[#9b87f5] to-[#FFDEE2] p-8 md:p-12 text-center">
                <h2 className="font-playfair text-2xl md:text-3xl mb-4 text-white">Monthly Membership</h2>
